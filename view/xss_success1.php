    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Lab1: Non-Persistent XSS</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
                ...
                <p>Our online store has a new promotion: if you buy any laptop, you will get a $200 gift card for free.</p>
                <a href='xss1.html'>Go back to previous page >></a>
            </div>        
        </div>        
    </div>
